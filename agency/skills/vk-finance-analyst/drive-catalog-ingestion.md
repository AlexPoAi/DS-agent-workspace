...
```
Жанна загружает → [Новые документы] → vk-finance-analyst обрабатывает → [Обработано]
                                                                        ↓
                                                              [Каталог] 1QEQcMso75T5WJt3N4bEbFwl7_6e6vLJb
```

Для истории цен — читать ВСЕ каталоги из «Обработано» и «Каталог».
